<div class="col-md-10 col-xl-8 mx-auto">
    ...
    <p class="lead text-center mb-4">Your account's credit can be used to make purchases. Any available credit will be automatically applied towards invoices generated for this account.</p>
                ...
                <div class="col-sm-4 mb-3 mb-md-0">
                    <div class="card text-center h-100">
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <a href="#" class="btn btn-lg btn-outline-primary">Pay</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4 mb-3 mb-md-0">
                    <div class="card text-center h-100">
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                <a href="#" class="btn btn-lg btn-primary">Pay</a>
                            </div>
                        </div>
                    </div>
                </div>
